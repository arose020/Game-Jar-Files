...
public class Game extends Canvas implements Runnable {
	...
	public static String title = "Captain Andrew Beta v4.1 Made by: Andrew Rosenthal";
	...
	public static void main(String[] args) {
		...
		game.frame.add(game);
		game.frame.pack();
		game.frame.setDefaultCloseOperation(JFrame.EXIT_ON_CLOSE); //DONT FUCK WITH THIS LINE BRO
